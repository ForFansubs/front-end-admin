...
export default function LoginModal() {
    ...
    const handleSubmitForm = (event) => {
        ...
        axios
            ...
            .catch((err) => {
                const errors = err.response.data.username
                    ? err.response.data
                    : { username: t("login.errors.error") };
    ...
    return (
        <>
            <div className={classes.ModalContainer}>
                <Box p={2} bgcolor='background.level1' boxShadow={2}>
